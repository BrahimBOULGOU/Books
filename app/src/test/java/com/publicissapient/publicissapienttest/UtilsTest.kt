...
import com.publicissapient.publicissapienttest.utils.Utils.applyOffer
...
class UtilsTest {
    ...
    val totalAmount = 65f
    val expectAmount = 50f

    @Test
    fun testBestOffer(){
       val bestOffer =  applyOffer(Offers(offers) , Books(books), totalAmount)
       Assert.assertEquals(expectAmount, bestOffer)
    }
