...
import com.publicissapient.publicissapienttest.ui.ListSynopsisViewHolder

class SynopsisAdapter(private val synopsis: ArrayList<String>) : RecyclerView.Adapter<ListSynopsisViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListSynopsisViewHolder {
        ...
        return ListSynopsisViewHolder(inflatedView)
    }
